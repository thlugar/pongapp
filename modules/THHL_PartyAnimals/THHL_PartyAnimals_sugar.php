 ...
 * PLACE ANY CUSTOMIZATIONS IN THHL_PartyAnimals
 */

require_once('include/SugarObjects/templates/person/Person.php');

class THHL_PartyAnimals_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'THHL_PartyAnimals';
	var $object_name = 'THHL_PartyAnimals';
	var $table_name = 'thhl_partyanimals';
	var $importable = true;
		var $id;
		var $name;
		var $date_entered;
		...
		function THHL_PartyAnimals_sugar(){	
		parent::Person();
	}
